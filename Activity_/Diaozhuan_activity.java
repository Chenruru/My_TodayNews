...
import test.bwie.com.my_todaynews.Adapter.OtherAdapter;
import test.bwie.com.my_todaynews.R;
import test.bwie.com.my_todaynews.Utils.ButtonUtils;
import test.bwie.com.my_todaynews.view.MyGridView;

public class Diaozhuan_activity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diaozhuan_activity);
        initView();
    ...
    public void initView() {
        ...
        mUserGv.setOnItemClickListener(Diaozhuan_activity.this);
        mOtherGv.setOnItemClickListener(Diaozhuan_activity.this);
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        switch (parent.getId()) {
            ...
            case R.id.otherGridView:
                ...
                if (!ButtonUtils.isFastDoubleClick(R.id.otherGridView)){
                    final ImageView moveImageView = getView(view);
                    if (moveImageView != null) {
                        TextView newTextView = (TextView) view.findViewById(R.id.text_item);
                        final int[] startLocation = new int[2];
